...
module.exports.run = async (bot,message,args) => {
    ...
    .addField("🎍 Способы оплаты", "🔸Qiwi - *8 913 001-59-97* (Указать что вы покупаете, а также ваш дискриминатор(Например: #9999) и айди в Discord. **Обязательно вступить в официальную группу бота: https://discord.gg/36xFsUm (Иначе донат не прийдет)**")
